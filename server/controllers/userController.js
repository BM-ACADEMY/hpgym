...
//         { type: "text", text: String(formatDate(subscription.startDate)) }, // {{4}}
//         { type: "text", text: String(formatDate(subscription.startDate)) }, // {{5}}
//         { type: "text", text: String(formatDate(subscription.endDate)) },   // {{6}}
//         { type: "text", text: String(subscription.billedBy || "Admin") },   // {{7}}
//         { type: "text", text: String(formatCurrency(pkgFee)) },             // {{8}}
//         { type: "text", text: String(formatCurrency(total)) },              // {{9}}
//         { type: "text", text: String(formatCurrency(paid)) },               // {{10}}
//         { type: "text", text: String(formatCurrency(remaining)) },          // {{11}}
//         { type: "text", text: String(subscription.paymentMode || "Cash") }, // {{12}}
//         { type: "text", text: String(invoiceLink) },                        // {{13}}
//       ];
...
//   try {
//     const { startDate, endDate, planName, billedBy, packageFee, totalAmount, paidAmount, paymentMode, isActive } = req.body;
...
//       user.subscription = { planStatus: "inactive", startDate: null, endDate: null, planName: "", billedBy: "", packageFee: 0, totalAmount: 0, paidAmount: 0, paymentMode: "", lastReminderDate: null };
//       await user.save();
...
//     const subscriptionData = { user: user._id, planName, startDate, endDate, billedBy: billedBy || "Admin", packageFee: packageFee || 0, totalAmount: totalAmount || 0, paidAmount: paidAmount || 0, paymentMode, planStatus: "active" };
...
//     user.subscription = { planStatus: "active", startDate, endDate, planName, billedBy: billedBy || "Admin", packageFee: packageFee || 0, totalAmount: totalAmount || 0, paidAmount: paidAmount || 0, paymentMode, lastReminderDate: null };
